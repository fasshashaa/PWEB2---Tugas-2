...
// Destruct Koneksi / menutup koneksi
$tampilCourse->close();
?>
...
<div class="container">
        <div class="card">
      <!--Membuat judul header Courses didalam card-->
            <div class="card-header">
                Courses
            </div>
            <table>
                <thead>
      <!--Membuat Tabel untuk isi data-->
                    <tr>
                        <th>No</th>
                        <th>Code</th>
                        <th>Course</th>
                ...
                <tbody>
                    <?php 
                    //Menentukan nilai awal kolom nomer dari angka 1
                    $no = 1;
                    foreach($data as $row){
                    ?>
                        <tr>
                    <!--Memanggil data dari database untuk dimasukkan kedalam tabel data-->
                            <td><?php echo htmlspecialchars($no++, ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($row['code'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($row['name'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($row['sks'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($row['hours'], ENT_QUOTES, 'UTF-8'); ?></td>
                            <td><?php echo htmlspecialchars($row['meeting'], ENT_QUOTES, 'UTF-8'); ?></td>
