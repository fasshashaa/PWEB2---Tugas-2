  ...
  <body>
    <div class="wrapper">
      ...
      <div class="main-panel">
        ...
        <!--Main Content-->
        <?php
// Memanggil file koneksi.php untuk koneksi ke database
    ...
    <div class="container">
        <div class="card">
          <!-- Memberi judul di dalam card-->
            ...
            <!--Membuat tabel untuk data Dosen/Lecturer-->
            <table>
                <thead>
                    <tr>
                        <th>No</th>
                ...
                <tbody>
                    <?php 
                    //Memberikan nilai awal no dari angka 1
                    $no = 1;
                    foreach($data as $row){
                    ?>
                        <tr>
                          <!-- Memanggil data dari database kedalam tabel-->
                            ...
                            <td><?php echo htmlspecialchars($row['number_phone'], ENT_QUOTES, 'UTF-8'); ?></td>
